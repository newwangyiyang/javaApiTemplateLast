...
public class UploadUtils {
    ...
    public static String upload(MultipartFile file, HttpServletRequest request)
        ...
        // 文件保存位置
        String url = "/upload/" + dateStr + "/" + uuidThread+ filename.substring(filename.lastIndexOf("."));
    ...
    public String[] uploadFile(HttpServletRequest request) {
        ...
        // 上传
        List<FileItem> fiList = (List<FileItem>) fieldsMap
                .get(UploadUtils.FILE_FIELDS);
        if (fiList != null) {
