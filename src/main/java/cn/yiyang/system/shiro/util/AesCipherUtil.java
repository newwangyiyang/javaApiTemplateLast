...
import cn.yiyang.system.exception.CustomUnauthorizedException;
import cn.yiyang.system.shiro.util.common.Base64ConvertUtil;
import cn.yiyang.system.shiro.util.common.HexConvertUtil;
...
public class AesCipherUtil {
    ...
    public static String enCrypto(String str) {
        try {
            ...
            String encryptAESKey = PropertiesUtil.getProperty("encryptAESKey");
